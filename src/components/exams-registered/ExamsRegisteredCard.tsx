...
const RegisteredExamsCard: React.FC<ExamCardProps> = ({ exam }) => {
  ...
  return (
    <div className="bg-[#0A0A0A] text-black dark:text-white w-full max-w-[610px] rounded-lg mx-auto">
      <div className="p-4 sm:p-6 space-y-4">
        <h2 className="text-base sm:text-[16px] font-semibold">{exam.title}</h2>

        <p className="text-[#A0A0A0] text-xs sm:text-[12px]">
          {exam.description}
        </p>
        ...
        <div className="space-y-2 text-sm">
          {[
            ...
            { label: "DURATION", value: exam.duration },
            {
              ...
              value: exam.registeredCandidates,
            },
            ...
            <div
              key={label}
              className="flex text-xs sm:text-[12px] items-center"
            >
        ...
        <button
          ...
          className="text-sm sm:text-[16px] w-full my-3 py-3 text-black dark:text-white border rounded-xl border-[#D0EFB1] hover:bg-[#262626] transition-colors"
        >
          VIEW DETAILS
        </button>
      </div>
      ...
      >
        <div className="flex min-h-full items-center justify-center">
          <div
            className="fixed inset-0 bg-white dark:bg-black/50"
            aria-hidden="true"
          />
          ...
          >
            <button
              ...
              className="absolute top-4 right-4 text-black dark:text-white hover:text-black dark:text-gray-300 z-10"
            >
              <X size={24} />
            </button>
            ...
            <div className="p-4 sm:p-8 space-y-6 pr-4 sm:pr-8">
              ...
              <p className="text-xs sm:text-[12px] font-[500]">
                {exam.description}
              </p>
              ...
              <div className="space-y-2 text-sm">
                {[
                  ...
                  <div
                    ...
                    className="flex text-xs sm:text-[12px] items-center"
                  >
                    <span className="font-[500] text-[#A0A0A0]">
                      {label}: &nbsp;
                    </span>
              ...
              <div className="grid gap-6 sm:grid-cols-1">
                <div>
                  <h3 className="text-xs text-[#6E6E6E] font-[500] mb-4">
                    TOPICS COVERED
                  </h3>
              ...
              <div className="flex flex-col sm:flex-row justify-between space-y-4 sm:space-y-0 sm:space-x-4 mt-6">
                <button
                  onClick={() => setIsModalOpen(false)}
                  className="px-6 py-3 border border-[#262626] text-black dark:text-white rounded-lg hover:bg-[#262626] transition-colors"
                >
                  Close
                </button>
                <button className="px-6 py-3 bg-[#1B1B1B] text-black dark:text-white border border-[#262626] rounded-lg hover:bg-[#262626] transition-colors">
                  Access Exam
                </button>
              </div>
            </div>
