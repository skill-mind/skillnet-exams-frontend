  ...
  return (
    <>
      <Dialog
        ...
        className="fixed w-full inset-0 flex items-center z-50 justify-center h-full backdrop-blur-md"
      >
        <div className="border w-[98%] lg:w-[50%] bg-black  rounded-[12px] h-[90%] lg:h-[735px] border-[#252625] flex flex-col">
          <DialogPanel className="w-full h-full bg-transparent border-none ">
              ...
              <div className="flex border-b border-[#222220] p-4 w-full items-center justify-between gap-2">
                <div className="gap-2 flex  items-center">
                  <Button
                    ...
                    className="text-[#ABABAB] font-medium text-base"
                  >
