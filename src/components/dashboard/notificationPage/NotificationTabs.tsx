  ...
  return (
    <div className="w-full p-6">
      <Tabs.Root defaultValue="exams" className="flex flex-col">
        {/* Tab List */}
        <Tabs.List className="flex flex-wrap mb-6 p-1 gap-1 bg-[#1a1a1a] rounded-xl w-full md:w-fit overflow-hidden">
          {tabs.map((tab) => (
            <Tabs.Trigger
              key={tab.id}
              value={tab.id}
        ...
        data-[state=active]:from-[#2a2a2a] 
        data-[state=active]:to-[#323232] 
