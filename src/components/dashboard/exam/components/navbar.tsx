    ...
    <header className="sticky top-0 z-50 w-full py-9 bg-white dark:bg-black">
      <div className="flex items-center w-full justify-between">
        ...
        <div className="flex items-center gap-0.5 md:gap-4">
          ...
          {address ? (
            <div className="flex items-center gap-2 rounded-lg w-40 bg-white dark:bg-[#161716] px-2.5 py-2">
              ...
              <div className="relative flex items-center" ref={dropdownRef}>
                ...
                {dropdownOpen && (
                  <div className="absolute -right-2 top-6 z-10 mt-4 w-56 origin-top-right rounded-md border border-zinc-700 bg-white dark:bg-[#161716] p-1 text-popover-foreground shadow-md focus:outline-none">
                    <button
