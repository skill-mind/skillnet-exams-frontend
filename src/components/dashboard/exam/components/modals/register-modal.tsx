      ...
      <form onSubmit={handleSubmit} className="space-y-6 ">
        <div className="space-y-0.5">
          ...
          <input
            ...
            required
            className="w-full rounded-md border border-zinc-700 bg-transparent px-3 py-2 text-white placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-600"
          />
        </div>
