  ...
  return (
    <div className="w-full rounded-[8px] border border-[#313130]">
      <div className="w-full h-[60px] md:h-[72px] gap-[10px] p-4 md:p-[24px] border-b border-[#313130] flex items-center">
        <div className="font-['Ubuntu_Sans'] font-semibold text-[18px] md:text-[20px] leading-[100%] tracking-[0%] text-black dark:text-[#FCFCFC]">
          Preview
        </div>
      </div>
          ...
          {questions.map((question) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`w-6 h-6 border rounded-[4px] flex items-center justify-center 
                  ${
                    isChecked
