...
export default function EndExamComponent({
  score = 0,
  onCancel,
  onSubmit,
}: EndExamComponentProps) {
  return (
    <div className="w-full max-w-[1240px] mx-auto mt-8 md:mt-[190px] flex flex-col gap-6">
      ...
      <section className="w-full rounded-lg border border-[#313130]">
        <div className="p-4 md:p-6 border-b border-[#313130]">
          <h1 className="font-['Ubuntu_Sans'] font-semibold text-lg md:text-xl lg:text-2xl text-black dark:text-[#FCFCFC]">
      ...
      <section className="w-full rounded-lg border border-[#313130]">
        <div className="p-4 md:p-6 border-b border-[#313130]">
          <h2 className="font-['Ubuntu_Sans'] font-semibold text-lg md:text-xl text-black dark:text-[#FCFCFC]">
            Once you submit:
          </h2>
        </div>
        ...
        <div className="p-4 md:p-6 flex flex-col gap-4 md:gap-6">
          {[
            ...
            <div key={index} className="flex items-start gap-3">
              ...
              <p className="font-['Ubuntu_Sans'] text-base md:text-lg text-black dark:text-[#FCFCFC]">
                {item}
              </p>
            </div>
          ))}
