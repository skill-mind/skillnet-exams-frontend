...
export default function AllTimeEarns() {
  ...
  return (
    <div className="bg-transparent text-white">
      <div className=" bg-gray-200 dark:bg-[#161716] w-[332px] h-[124px] rounded-md mb-8 flex items-center justify-center">
      ...
      <div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="text-left    text-black bg-gray-200 dark:bg-[#161716] ">
