...
const InstitutionModal: React.FC<InstitutionModalProps> = ({ institution, isOpen, onClose }) => {
      ...
      <div className="relative bg-[#161716] border border-[#313130] rounded-lg w-full max-w-2xl mx-4 my-6 z-10 max-h-[90vh] overflow-y-auto">
        <div className="p-4 sm:p-6">
          <div className="flex justify-between items-center mb-6 sm:mb-8">
            <h2 className="text-lg sm:text-xl font-medium text-white">Institution</h2>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center">
              ...
              <span className="hidden sm:block text-[#C04639] mx-2">–</span>
              <span className="text-white break-all">{institution.walletAddress}</span>
            </div>
            ...
            {/* Location */}
            <div className="flex flex-col sm:flex-row sm:items-center">
              <span className="text-[#6E6E6E] w-full sm:w-32 mb-1 sm:mb-0">Location</span>
              <span className="hidden sm:block text-[#C04639] mx-2">–</span>
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center mb-2 sm:mb-4">
                <span className="text-[#6E6E6E] w-full sm:w-32 mb-1 sm:mb-0">Exams Created</span>
                <span className="hidden sm:block text-[#C04639] mx-2">–</span>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:ml-40">
                {institution.exams.map((exam, index) => (
                  <div key={index} className="bg-[#1B1B1B] rounded-md p-3">
                    ...
                    <p className={`text-xs ${exam.status === "Completed" ? "text-[#898783]" : "text-[#898783]"}`}>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center">
              ...
              <span className="hidden sm:block text-[#C04639] mx-2">–</span>
              <span className={`${institution.status === "Active" ? "text-[#898783]" : "text-yellow-400"}`}>
                {institution.status}
              </span>
            </div>
          </div>
