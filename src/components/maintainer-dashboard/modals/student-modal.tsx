        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center">
              ...
              {/* Dynamically display student name */}
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center">
              ...
              {/* Dynamically display wallet address */}
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center">
              ...
              <span className="hidden sm:block text-[#C04639] mx-2">–</span>
              <span className="text-white">{student.joinDate}</span>{" "}
              {/* Dynamically display join date */}
            </div>
            ...
            <div>
              <div className="flex flex-col sm:flex-row sm:items-center mb-2 sm:mb-4">
                ...
                <span className="hidden sm:block text-[#C04639] mx-2">–</span>
                <span className="text-white">{student.coursesTaken}</span>{" "}
                {/* Dynamically display courses taken */}
              </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center">
              ...
              <span className="hidden sm:block text-[#C04639] mx-2">–</span>
              <span className="text-white">{student.jobsApplied}</span>{" "}
              {/* Dynamically display job applied */}
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center">
              ...
              <span className="hidden sm:block text-[#C04639] mx-2">–</span>
              <span className="text-[#898783]">{student.status}</span>{" "}
              {/* Dynamically display student status */}
            </div>
          </div>
