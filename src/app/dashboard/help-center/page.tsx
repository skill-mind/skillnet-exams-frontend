    ...
    return (
        <DashboardLayout title="Help" activePage="help">
            <div className="flex flex-wrap gap-4 mb-8 p-5 rounded-md bg-[#0B1739]">
                ...
                <p className='text-[14px] text-[#D9D9D9]'>SkillNet is not just an exam platform—it's a game-changer. Designed to deliver secure, transparent, and verifiable academic records, SkillNet leverages cutting-edge blockchain technology, AI proctoring, and NFT-based certificate minting</p>
