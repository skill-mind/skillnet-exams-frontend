  ...
  return (
    <div className="text-white">
      ...
      <table className="w-[95%] mb-6 text-left">
        ...
        <tbody>
          <tr className="border-b border-[#31283A]">
            ...
            <td className="py-3">
              <button className="px-4 py-1 text-white rounded-2xl border border-[#2D2E2D] hover:bg-zinc-600">View</button>
            </td>
            <td className="py-3 text-gray-400">Scheduled</td>
          </tr>
        </tbody>
        <tbody>
          <tr className="border-b border-[#31283A]">
            ...
            <td className="py-3 text-gray-400">Unverified</td>
          </tr>
        </tbody>
      </table>
      ...
      <div className="pt-14">
        ...
        <div className="bg-[#161716] w-[95%] h-[40%] rounded-lg pb-5">
          <p className="text-sm text-gray-400 text-center pt-8 pb-7">
            Create an exam, set a date for takers.
          </p>
          <div className="bg-[#2D2E2D] w-16 h-16 pt-4 rounded-full ml-[38%] lg:ml-[45%] ">
            <Plus size={30} className="ml-4" />
          </div>
          <button
            className="flex mt-4 text-sm bg-[#2D2E2D] hover:bg-gray-600 px-4 py-2 rounded ml-[20%] lg:ml-[40%]"
