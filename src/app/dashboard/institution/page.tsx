  ...
  return (
    <InstitutionLayout title="Institution Dashboard" activePage="Dashboard">
      <Suspense fallback={<div>Loading...</div>}>
        {isModalOpen && selectedExam && <ExamDetailsModal exam={selectedExam} onClose={handleCloseModal} />}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div>
              ...
              <div className="bg-[#0f1c3f] rounded-lg p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  {exams.map((exam) => (
                    <ExamCard key={exam.id} exam={exam} onTakeExam={() => handleOpenModal(exam)} />
                  ))}
                </div>
                <Link
                  href="/exams"
            ...
            <div>
              ...
              <div className="bg-[#0f1c3f] rounded-lg p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                  {exams.map((exam) => (
                    <ExamCard key={`draft-${exam.id}`} exam={exam} onTakeExam={() => handleOpenModal(exam)} />
                  ))}
                </div>
                <Link
                  href="/exams"
